...
{
    public class TorCalculation : ElementCalculation, IFigureResult, IStateProtocol, IAdjustment
    {
        public TorCalculation()
        {
        ...
        public void DrawElement( Graphics graphics, Rectangle rectangle )
        {
            ...
            if ( !GetRecord( "RPV" ).Value.Equals( 0 ))
            {
            ...
            {
                Console.WriteLine("LibraryElements.TorCalculation.cs: в мнемосхеме у TOP отсутствует Failure-запись");
            }    
        }
        public override string ToString() { return "TorCalculation"; }
