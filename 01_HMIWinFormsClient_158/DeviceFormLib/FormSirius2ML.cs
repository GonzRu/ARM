...
{
    public partial class FormSirius2ML : Form, IDeviceForm, ReportLibrary.IReport
    {
        TabPage tpCurrent;
        ...
        /// <summary>
        /// флаг - показывать ли сообщение об отсутсвии архивных записей 
        /// или нет
        /// </summary>
        Boolean isMesView;
        ...
        public FormSirius2ML( UInt32 unids, UInt32 unidev )
        {
            InitializeComponent();
