...
{
    public partial class FormSirius2V : Form, IDeviceForm, ReportLibrary.IReport
    {
        TabPage tpCurrent;
        ...
        public FormSirius2V( UInt32 unids, UInt32 unidev )
        {
            InitializeComponent();
        ...
        private void OperationControl5ButtonOneClick( object sender, EventArgs e )
        {
            ...
            if ( MessageBox.Show( "Выполнить ввод?", "Попытка ввода ЛЗШ", MessageBoxButtons.YesNo, MessageBoxIcon.Question )
                == DialogResult.No )
                return;

            /*ICommand cmd = */
            HMI_Settings.CONFIGURATION.ExecuteCommand( 0, uniDev, "LS1", new byte[] { }, this );
        }
        /// <summary>
        /// ЛЗШ вывести
        /// </summary>
        private void OperationControl5ButtonTwoClick( object sender, EventArgs e )
        {
            ...
            if ( MessageBox.Show( "Выполнить вывод?", "Попытка вывода ЛЗШ", MessageBoxButtons.YesNo, MessageBoxIcon.Question )
                == DialogResult.No )
                return;

            /*ICommand cmd = */
            HMI_Settings.CONFIGURATION.ExecuteCommand( 0, uniDev, "LS0", new byte[] { }, this );
        }
        /// <summary>
