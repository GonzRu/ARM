...
{
    public partial class FormSiriusT3 : Form, IDeviceForm, ReportLibrary.IReport
    {
        TabPage tpCurrent;
        ...
        public FormSiriusT3( UInt32 unids, UInt32 unidev )
        {
            InitializeComponent();
        ...
        private void OperationControl2ButtonOneClick( object sender, EventArgs e )
        {
            ...
            if ( MessageBox.Show( "Выполнить ввод?", "Попытка ввода ДЗТ", MessageBoxButtons.YesNo, MessageBoxIcon.Question )
                == DialogResult.No )
                return;

            /*ICommand cmd = */
            HMI_Settings.CONFIGURATION.ExecuteCommand( 0, uniDev, "DT1", new byte[] { }, this );
        }
        /// <summary>
        /// ДЗТ вывести
        /// </summary>
        private void OperationControl2ButtonTwoClick( object sender, EventArgs e )
        {
            ...
            if ( MessageBox.Show( "Выполнить вывод?", "Попытка вывода ДЗТ", MessageBoxButtons.YesNo, MessageBoxIcon.Question )
                == DialogResult.No )
                return;

            /*ICommand cmd = */
            HMI_Settings.CONFIGURATION.ExecuteCommand( 0, uniDev, "DT0", new byte[] { }, this );
        }
        /// <summary>
        /// МТЗ ВН ввести
        /// </summary>
        private void OperationControl3ButtonOneClick( object sender, EventArgs e ) { }
        /// <summary>
        /// МТЗ ВН вывести
        /// </summary>
        private void OperationControl3ButtonTwoClick( object sender, EventArgs e ) { }
        /// <summary>
        /// МТЗ СН/НН ввести
        /// </summary>
        private void OperationControl4ButtonOneClick( object sender, EventArgs e )
        {
            if ( CommonUtils.CommonUtils.IsUserActionBan( CommonUtils.CommonUtils.UserActionType.b00_Control_Switch, HMI_Settings.UserRight ) )
                return;
            ...
            if ( MessageBox.Show( "Выполнить ввод?", "Попытка ввода МТЗ СН/НН", MessageBoxButtons.YesNo, MessageBoxIcon.Question )
                == DialogResult.No )
                return;

            /*ICommand cmd = */
            HMI_Settings.CONFIGURATION.ExecuteCommand( 0, uniDev, "SN1", new byte[] { }, this );
        }
        /// <summary>
        /// МТЗ СН/НН вывести
        /// </summary>
        private void OperationControl4ButtonTwoClick( object sender, EventArgs e )
        {
            if ( CommonUtils.CommonUtils.IsUserActionBan( CommonUtils.CommonUtils.UserActionType.b00_Control_Switch, HMI_Settings.UserRight ) )
                return;
            ...
            if ( MessageBox.Show( "Выполнить вывод?", "Попытка вывода МТЗ СН/НН", MessageBoxButtons.YesNo, MessageBoxIcon.Question )
                == DialogResult.No )
                return;

            /*ICommand cmd = */
            HMI_Settings.CONFIGURATION.ExecuteCommand( 0, uniDev, "SN0", new byte[] { }, this );
        }
        /// <summary>
        /// ГЗТ ввести
        /// </summary>
        private void OperationControl5ButtonOneClick( object sender, EventArgs e )
        {
            if ( CommonUtils.CommonUtils.IsUserActionBan( CommonUtils.CommonUtils.UserActionType.b00_Control_Switch, HMI_Settings.UserRight ) )
                return;
            ...
            if ( MessageBox.Show( "Выполнить ввод?", "Попытка ввода газовой защиты", MessageBoxButtons.YesNo, MessageBoxIcon.Question )
                == DialogResult.No )
                return;

            /*ICommand cmd = */
            HMI_Settings.CONFIGURATION.ExecuteCommand( 0, uniDev, "GZ1", new byte[] { }, this );
        }
        /// <summary>
        /// ГЗТ вывести
        /// </summary>
        private void OperationControl5ButtonTwoClick( object sender, EventArgs e )
        {
            if ( CommonUtils.CommonUtils.IsUserActionBan( CommonUtils.CommonUtils.UserActionType.b00_Control_Switch, HMI_Settings.UserRight ) )
                return;
            ...
            if ( MessageBox.Show( "Выполнить вывод?", "Попытка вывода газовой защиты", MessageBoxButtons.YesNo, MessageBoxIcon.Question )
                == DialogResult.No )
                return;

            /*ICommand cmd = */
            HMI_Settings.CONFIGURATION.ExecuteCommand( 0, uniDev, "GZ0", new byte[] { }, this );
        }
        /// <summary>
        /// ГЗ РПН ввести
        /// </summary>
        private void OperationControl6ButtonOneClick( object sender, EventArgs e )
        {
            if ( CommonUtils.CommonUtils.IsUserActionBan( CommonUtils.CommonUtils.UserActionType.b00_Control_Switch, HMI_Settings.UserRight ) )
                return;
            ...
            if ( MessageBox.Show( "Выполнить ввод?", "Попытка ввода ГЗ РПН", MessageBoxButtons.YesNo, MessageBoxIcon.Question )
                == DialogResult.No )
                return;

            /*ICommand cmd = */
            HMI_Settings.CONFIGURATION.ExecuteCommand( 0, uniDev, "RN1", new byte[] { }, this );
        }
        /// <summary>
        /// ГЗ РПН вывести
        /// </summary>
        private void OperationControl6ButtonTwoClick( object sender, EventArgs e )
        {
            if ( CommonUtils.CommonUtils.IsUserActionBan( CommonUtils.CommonUtils.UserActionType.b00_Control_Switch, HMI_Settings.UserRight ) )
                return;
            ...
            if ( MessageBox.Show( "Выполнить вывод?", "Попытка вывода ГЗ РПН", MessageBoxButtons.YesNo, MessageBoxIcon.Question )
                == DialogResult.No )
                return;

            /*ICommand cmd = */
            HMI_Settings.CONFIGURATION.ExecuteCommand( 0, uniDev, "RN0", new byte[] { }, this );
        }
        /// <summary>
