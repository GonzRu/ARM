...
{
    public partial class FormSirius3DZSH : Form, IDeviceForm, ReportLibrary.IReport
    {
        TabPage tpCurrent;
        ...
        public FormSirius3DZSH( UInt32 unids, UInt32 unidev )
        {
            InitializeComponent();
        ...
        private void OperationControl1ButtonOneClick( object sender, EventArgs e )
        {
            ...
            if ( MessageBox.Show( "Выполнить деблокировку?", "Попытка деблокировки", MessageBoxButtons.YesNo, MessageBoxIcon.Question )
                == DialogResult.No )
                return;

            /*ICommand cmd = */
            HMI_Settings.CONFIGURATION.ExecuteCommand( 0, uniDev, "DBL", new byte[] { }, this );
        }
        /// <summary>
