...
{
    public partial class FormBmrz100SeriesDevice : Form, IDeviceForm
    {
        TabPage tpCurrent;
        ...
        public FormBmrz100SeriesDevice( UInt32 unids, UInt32 unidev, string name )
        {
            InitializeComponent();
            ...
            try
            {
                ...
                comboChoiseIndex = cbTypeInfo1.SelectedIndex =
                                   cbTypeInfo2.SelectedIndex = cbTypeInfo3.SelectedIndex = 0;
        ...
        public void InitInterfaceElementsClick()
        {
            ...
            cbTypeInfo1.SelectedIndexChanged += CbTypeInfoSelectedIndexChanged;
            cbTypeInfo2.SelectedIndexChanged += CbTypeInfoSelectedIndexChanged;
            cbTypeInfo3.SelectedIndexChanged += CbTypeInfoSelectedIndexChanged;
        ...
        private void TabEnter( object sender, EventArgs e )
        {
            ...
            cbTypeInfo1.SelectedIndex = cbTypeInfo2.SelectedIndex = cbTypeInfo3.SelectedIndex = comboChoiseIndex;
