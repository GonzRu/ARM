...
{
    public partial class FormSiriusD : Form, IDeviceForm, ReportLibrary.IReport
    {
        TabPage tpCurrent;
        ...
        public FormSiriusD( UInt32 unids, UInt32 unidev )
        {
            InitializeComponent();
        ...
        private void OperationControl1ButtonOneClick( object sender, EventArgs e )
        {
            ...
            if ( MessageBox.Show( "Включить?", "Попытка вкл. выключателя", MessageBoxButtons.YesNo, MessageBoxIcon.Question )
                == DialogResult.No )
                return;

            /*ICommand cmd = */
            HMI_Settings.CONFIGURATION.ExecuteCommand( 0, uniDev, "CCB", new byte[] { }, this );
        }
        /// <summary>
        /// Выключатель отключить
        /// </summary>
        private void OperationControl1ButtonTwoClick( object sender, EventArgs e )
        {
            ...
            if ( MessageBox.Show( "Отключить?", "Попытка откл. выключателя", MessageBoxButtons.YesNo, MessageBoxIcon.Question )
                == DialogResult.No )
                return;

            /*ICommand cmd = */
            HMI_Settings.CONFIGURATION.ExecuteCommand( 0, uniDev, "OCB", new byte[] { }, this );
        }
        /// <summary>
        /// Квитировать
        /// </summary>
        private void OperationControl2ButtonOneClick( object sender, EventArgs e )
        {
            ...
            if ( MessageBox.Show( "Квитировать?", "Попытка квитирования", MessageBoxButtons.YesNo, MessageBoxIcon.Question )
                == DialogResult.No )
                return;

            /*ICommand cmd = */
            HMI_Settings.CONFIGURATION.ExecuteCommand( 0, uniDev, "ECC", new byte[] { }, this );
        }
        /// <summary>
        /// ЗМН ввести
        /// </summary>
