...
{
    public partial class FormSiriusUV : Form, IDeviceForm, ReportLibrary.IReport
    {
        TabPage tpCurrent;
        ...
        public FormSiriusUV( UInt32 unids, UInt32 unidev )
        {
            InitializeComponent();
        ...
        private void OperationControl3ButtonOneClick( object sender, EventArgs e )
        {
            ...
            if ( MessageBox.Show( "Выполнить ввод?", "Попытка ввода МТЗ", MessageBoxButtons.YesNo, MessageBoxIcon.Question )
                == DialogResult.No )
                return;

            /*ICommand cmd = */
            HMI_Settings.CONFIGURATION.ExecuteCommand( 0, uniDev, "MZ1", new byte[] { }, this );
        }
        /// <summary>
        /// МТЗ вывести
        /// </summary>
        private void OperationControl3ButtonTwoClick( object sender, EventArgs e )
        {
            ...
            if ( MessageBox.Show( "Выполнить вывод?", "Попытка вывода МТЗ", MessageBoxButtons.YesNo, MessageBoxIcon.Question )
                == DialogResult.No )
                return;

            /*ICommand cmd = */
            HMI_Settings.CONFIGURATION.ExecuteCommand( 0, uniDev, "MZ0", new byte[] { }, this );
        }
        /// <summary>
        /// ТЗНП ввести
        /// </summary>
        private void OperationControl4ButtonOneClick( object sender, EventArgs e )
        {
            ...
            if ( MessageBox.Show( "Выполнить ввод?", "Попытка ввода ТЗНП", MessageBoxButtons.YesNo, MessageBoxIcon.Question )
                == DialogResult.No )
                return;

            /*ICommand cmd = */
            HMI_Settings.CONFIGURATION.ExecuteCommand( 0, uniDev, "TP0", new byte[] { }, this );
        }
        /// <summary>
        /// ТЗНП вывести
        /// </summary>
        private void OperationControl4ButtonTwoClick( object sender, EventArgs e )
        {
            ...
            if ( MessageBox.Show( "Выполнить вывод?", "Попытка вывода ТЗНП", MessageBoxButtons.YesNo, MessageBoxIcon.Question )
                == DialogResult.No )
                return;
