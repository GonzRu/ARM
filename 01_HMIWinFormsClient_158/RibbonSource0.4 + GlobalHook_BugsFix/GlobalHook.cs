...
namespace System.Windows.Forms.RibbonHelpers
{
        ...
        : IDisposable
    {
        ...
        private void InstallHook()
        {
            ...
            if ( _hHook == 0 ) _hHook = WinApi.SetWindowsHookEx( htype, _HookProc, IntPtr.Zero, 0 );  // FIX 2
            else _hHook = WinApi.SetWindowsHookEx( htype, _HookProc, GetCurrentModule().BaseAddress, 0 ); // FIX 2
