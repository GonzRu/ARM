...
namespace HMI_MT
{
    public partial class frmLogs : Form
    {
       ...
       #region Конструкторы
        ...
        /// <summary>
        /// Обработчик события входа на вкладку с событиями терминалов
        /// </summary>
        ...
        /// <summary>
        /// Событие входа на вкладку пользовательских событий
        /// </summary>
        ...
        #region Вкладка сводного журнала

        /// <summary>
        /// Обработчик события входа на вкладку сводного журнала
        /// </summary>
        ...
        #region Общий методы и обработчики
        ...
        /// <summary>
        /// CheckBox "Обновлять периодически"
        /// </summary>
        ...
        /// <summary>
        /// Метод, вызывающийся таймером автоматического обновления
        /// </summary>
        ...
        /// <summary>
        /// Обработчик нажатия на кнопку "Вывод текущего журнала в файл"
        /// </summary>
        ...
        #region Методы для потокобезопаного обновления таблиц (?)
     ...
     *==========================================================================*/
        ...
        *==========================================================================*/
        ...
        /// <summary>
        /// Возвращает DataGridViewCell по номеру столбца и ячейки из таблицы аварий
        /// </summary>
